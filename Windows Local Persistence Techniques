...
Objective:
Gained and maintained persistent access on a Windows target through multiple privilege escalation and backdoor techniques.  
...
• Sticky Keys Backdoor: Replaced sethc.exe with cmd.exe to spawn a SYSTEM shell via the login screen (SHIFTx5).  
